...
public class Instr {
	...
	/**
	 * Limin 04 AMR r, x, addrees[, l] Add memory to the Register, r=0,1,2,3 r<-
	 * c(r)+c(EA)
	 */
	...
	/**
	 * Limin 05 SMR r, x, addrees[, l] Subtract memory from the Register, r=0,1,2,3
	 * r<- c(r)-c(EA)
	 */
	...
	/**
	 * Limin 06 AIR r, immed Add Immediate to register, r = 0,1,2,3
	...
	/**
	 * Limin 07 SIR r, immed Subtract Immediate from register. r=0...3 r<-c(r) -
	...
	/**
	 * Limin 20 MLT rx, ry Multiply Register by Register rx, rx+1 < c(rx)*c(ry) rx
	...
	/**
	 * Limin 21 DVD rx, ry Divide Register by Register rx, rx+1 <- c(rx)/ c(ry) rx
	...
	/**
	 * Limin 22 TRR rx, ry Test the Equality of Register and Register If c(rx) =
	...
	/**
	 * Limin 23 AND rx, ry Logical And of Register and Register c(rx) <- c(rx) AND
	 * c(ry)
	 */
